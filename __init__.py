...
class PcgNewControlNode(PcgNewNode):
...
class NewInfoSocket(NodeSocket, PcgNewNodeSocket):
    bl_idname = "NewInfoSocket"
    bl_label = "New Info"
...
class NewPrintNode(Node, PcgNewNode):
    ...
    def init(self, context):
        self.inputs.new("NewUniversalSocket", "Value").prop_prop = "prop_value"
        self.outputs.new("NewUniversalSocket", "Value")
...
class NewFloat(Node, PcgNewConstantNode):
    ...
    prop_float = FloatProperty(name="Float", update=PcgNewNode.update_value)
...
class NewInt(Node, PcgNewConstantNode):
    ...
    prop_int = IntProperty(name="Integer", update=PcgNewNode.update_value)
...
class NewBool(Node, PcgNewConstantNode):
    ...
    prop_bool = BoolProperty(name="Boolean", update=PcgNewNode.update_value)
...
class NewAngle(Node, PcgNewConstantNode):
    ...
    prop_angle = FloatProperty(name="Angle", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
...
class NewFloatVector(Node, PcgNewConstantNode):
    ...
    prop_z = FloatProperty(name="Z", update=PcgNewNode.update_value)
    prop_uniform = EnumProperty(name="Uniform", items=[("NONE", "None", ""), ("XY", "XY", ""), ("YZ", "YZ", ""), ("XZ", "XZ", ""), ("XYZ", "XYZ", "")], default="NONE", update=PcgNewNode.update_value)
...
class NewAngleVector(Node, PcgNewConstantNode):
    ...
    prop_x = FloatProperty(name="X", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    prop_y = FloatProperty(name="Y", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    prop_z = FloatProperty(name="Z", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    prop_uniform = EnumProperty(name="Uniform", items=[("NONE", "None", ""), ("XY", "XY", ""), ("YZ", "YZ", ""), ("XZ", "XZ", ""), ("XYZ", "XYZ", "")], default="NONE", update=PcgNewNode.update_value)
    ...
    def post_execute(self):
        return self.prop_vector
class NewRandomFloat(Node, PcgNewConstantNode):
    bl_idname = "NewRandomFloat"
    bl_label = "New Random Float"

    prop_min = FloatProperty(name="Min", update=PcgNewNode.update_value)
    prop_max = FloatProperty(name="Max", default=1.0, update=PcgNewNode.update_value)
    prop_seed = IntProperty(name="Seed", update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewFloatSocket", "Min").prop_prop = "prop_min"
        self.inputs.new("NewFloatSocket", "Max").prop_prop = "prop_max"
        self.inputs.new("NewIntSocket", "Seed").prop_prop = "prop_seed"
...
class NewRandomInt(Node, PcgNewConstantNode):
    bl_idname = "NewRandomInt"
    bl_label = "New Random Integer"

    prop_min = IntProperty(name="Min", default=1, update=PcgNewNode.update_value)
    prop_max = IntProperty(name="Max", default=5, update=PcgNewNode.update_value)
    prop_seed = IntProperty(name="Seed", update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewIntSocket", "Min").prop_prop = "prop_min"
        self.inputs.new("NewIntSocket", "Max").prop_prop = "prop_max"
        self.inputs.new("NewIntSocket", "Seed").prop_prop = "prop_seed"
        self.outputs.new("NewIntSocket", "Value")
        super().init(context)
...
class NewRandomBool(Node, PcgNewConstantNode):
    bl_idname = "NewRandomBool"
    bl_label = "New Random Boolean"

    prop_seed = IntProperty(name="Seed", update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewIntSocket", "Seed").prop_prop = "prop_seed"
        self.outputs.new("NewBoolSocket", "Value")
        super().init(context)
...
class NewRandomAngle(Node, PcgNewConstantNode):
    bl_idname = "NewRandomAngle"
    bl_label = "New Random Angle"

    prop_min = FloatProperty(name="Min", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    prop_max = FloatProperty(name="Max", subtype="ANGLE", unit="ROTATION", default=3.14159, update=PcgNewNode.update_value)
    prop_seed = IntProperty(name="Seed", update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewAngleSocket", "Min").prop_prop = "prop_min"
        self.inputs.new("NewAngleSocket", "Max").prop_prop = "prop_max"
        self.inputs.new("NewIntSocket", "Seed").prop_prop = "prop_seed"
        self.outputs.new("NewAngleSocket", "Value")
        super().init(context)
...
class NewCylinderNode(Node, PcgNewInputNode):
    ...
    prop_vertices = IntProperty(name="Vertices", default=32, min=3, max=1000000, update=PcgNewNode.update_value)
    prop_radius = FloatProperty(name="Radius", default=1.0, min=0, update=PcgNewNode.update_value)
    prop_depth = FloatProperty(name="Depth", default=2.0, min=0, update=PcgNewNode.update_value)
    prop_end = EnumProperty(name="End Fill Type", items=[("NOTHING", "Nothing", "Don’t fill at all."), ("NGON", "Ngon", "Use ngons"), ("TRIFAN", "Triangle Fan", "Use triangle fans.")], default="NGON", update=PcgNewNode.update_value)
...
class NewCustomMeshNode(Node, PcgNewInputNode):
    bl_idname = "NewCustomMeshNode"
    bl_label = "New Custom Mesh"
    
    prop_mesh = PointerProperty(name="Mesh", type=bpy.types.Object, update=PcgNewNode.update_value)
...
class NewToComponentNode(Node, PcgNewConversionNode):
    ...
    prop_selection_type = EnumProperty(name="Component", items=[("FACE", "Faces", ""), ("VERT", "Vertices", ""), ("EDGE", "Edges", "")], default="FACE", update=PcgNewNode.update_value)
    prop_deselect = BoolProperty(name="Deselect All", default=True, update=PcgNewNode.update_value)
...
class NewLocationNode(Node, PcgNewTransformNode):
    ...
    prop_location = FloatVectorProperty(name="Location", update=PcgNewNode.update_value)
...
class NewRotateNode(Node, PcgNewTransformNode):
    ...
    prop_value = FloatProperty(name="Value", subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    prop_constraint_axis = EnumProperty(name="Constraint Axis", items=[("X", "X", ""), ("Y", "Y", ""), ("Z", "Z", "")], default="X", update=PcgNewNode.update_value)
...
class NewBevelModNode(Node, PcgNewModifierNode):
    ...
    width = FloatProperty(name="Width", default=0.1, min=0.0, update=PcgNewNode.update_value)
    segments = IntProperty(name="Segments", default=1, min=0, max=100, update=PcgNewNode.update_value)
    profile = FloatProperty(name="Profile", default=0.5, min=0.0, max=1.0, update=PcgNewNode.update_value)
    material = IntProperty(name="Material", default=-1, min=0, max=32767, update=PcgNewNode.update_value)
    use_only_vertices = BoolProperty(name="Only Vertices", update=PcgNewNode.update_value)
    use_clamp_overlap = BoolProperty(name="Clamp Overlap", default=True, update=PcgNewNode.update_value)
    loop_slide = BoolProperty(name="Loop Slide", default=True, update=PcgNewNode.update_value)
    limit_method = EnumProperty(name="Limit Method", items=[("NONE", "None", ""), ("ANGLE", "Angle", ""), ("WEIGHT", "Weight", "")], default="NONE", update=PcgNewNode.update_value)
    angle_limit = FloatProperty(name="Angle", default=0.523599, min=0.0, max=3.14159, subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
    offset_type = EnumProperty(name="Limit Method", items=[("OFFSET", "Offset", ""), ("WIDTH", "Width", ""), ("DEPTH", "Depth", ""), ("PERCENT", "Percent", "")], default="OFFSET", update=PcgNewNode.update_value)
...
class NewBooleanModNode(Node, PcgNewModifierNode):
    ...
    prop_op = EnumProperty(name="Operation", items=[("DIFFERENCE", "Difference", ""), ("UNION", "Union", ""), ("INTERSECT", "Intersect", "")], default="INTERSECT", update=PcgNewNode.update_value)
    prop_obj = PointerProperty(name="Object", type=bpy.types.Object)
    prop_overlap = FloatProperty(name="Overlap Threshold", default=0.000001, min=0.0, max=1.0, precision=6, update=PcgNewNode.update_value)
    prop_draw_mode = EnumProperty(items=[("SOLID", "Solid", ""), ("WIRE", "Wire", ""), ("BOUNDS", "Bounds", "")], default="WIRE", update=PcgNewNode.update_value)
...
class NewSelectAllNode(Node, PcgNewSelectionNode):
    ...
    prop_action = EnumProperty(name="Action", items=[("TOGGLE", "Toggle", ""), ("SELECT", "Select", ""), ("DESELECT", "Deselect", ""), ("INVERT", "Invert", "")], default="TOGGLE", update=PcgNewNode.update_value)
...
class NewDeleteNode(Node, PcgNewDeletionNode):
    ...
    prop_type = EnumProperty(name="Type", items=[("VERT", "Vertices", ""), ("EDGE", "Edges", ""), ("FACE", "Faces", ""), ("EDGE_FACE", "Edges And Faces", ""), ("ONLY_FACE", "Only Faces", "")], default="VERT", update=PcgNewNode.update_value)
...
class NewDissolveDegenerateNode(Node, PcgNewDeletionNode):
    ...
    prop_threshold = FloatProperty(name="Threshold", default=0.0001, min=0.000001, max=50.0, update=PcgNewNode.update_value)
...
class NewBevelNode(Node, PcgNewEditOperatorNode):
    ...
    prop_offset_type = EnumProperty(name="Offset Type", items=[("OFFSET", "Offset", ""), ("WIDTH", "Width", ""), ("PERCENT", "Percent", ""), ("DEPTH", "Depth", "")], default="OFFSET", update=PcgNewNode.update_value)
    prop_offset = FloatProperty(name="Offset", default=0.0, min=-1000000.0, max=1000000.0, update=PcgNewNode.update_value)
    prop_segments = IntProperty(name="Segments", default=1, min=1, max=1000, update=PcgNewNode.update_value)
    prop_profile = FloatProperty(name="Profile", default=0.5, min=0.15, max=1.0, update=PcgNewNode.update_value)
    prop_vertex_only = BoolProperty(name="Vertex Only", update=PcgNewNode.update_value)
    prop_clamp_overlap = BoolProperty(name="Clamp Overlap", update=PcgNewNode.update_value)
    prop_loop_slide = BoolProperty(name="Loop Slide", default=True, update=PcgNewNode.update_value)
    prop_material = IntProperty(name="Material", default=-1, min=-1, update=PcgNewNode.update_value)
...
class NewInsetNode(Node, PcgNewEditOperatorNode):
    ...
    prop_thickness = FloatProperty(name="Thickness", default=0.01, min=0.0, update=PcgNewNode.update_value)
    prop_depth = FloatProperty(name="Depth", update=PcgNewNode.update_value)
    prop_boundary = BoolProperty(name="Boundary", default=True, update=PcgNewNode.update_value)
    prop_even_offset = BoolProperty(name="Even Offset", default=True, update=PcgNewNode.update_value)
    prop_relative_offset = BoolProperty(name="Relative Offset", update=PcgNewNode.update_value)
    prop_edge_rail = BoolProperty(name="Edge Rail", update=PcgNewNode.update_value)
    prop_outset = BoolProperty(name="Outset", update=PcgNewNode.update_value)
    prop_select_inset = BoolProperty(name="Select Inset", update=PcgNewNode.update_value)
    prop_individual = BoolProperty(name="Individual", update=PcgNewNode.update_value)
    prop_interpolate = BoolProperty(name="Interpolate", default=True, update=PcgNewNode.update_value)
...
class NewOriginNode(Node, PcgNewObjectOperatorNode):
    ...
    prop_type = EnumProperty(name="Type", items=[("GEOMETRY_ORIGIN", "Geometry to Origin", ""), ("ORIGIN_GEOMETRY", "Origin to Geometry", ""), ("ORIGIN_CURSOR", "Origin to 3D Cursor", ""), ("ORIGIN_CENTER_OF_MASS", "Origin to Center of Mass (Surface)", ""), ("ORIGIN_CENTER_OF_VOLUME", "Origin to Center of Mass (Volume)", "")], default="GEOMETRY_ORIGIN", update=PcgNewNode.update_value)
    prop_center = EnumProperty(name="Center", items=[("MEDIAN", "Median", ""), ("BOUNDS", "Bounds", "")], default="MEDIAN", update=PcgNewNode.update_value)
...
class NewShadingNode(Node, PcgNewObjectOperatorNode):
    ...
    prop_shading = EnumProperty(name="Shading", items=[("SMOOTH", "Smooth", ""), ("FLAT", "Flat", "")], default="FLAT", update=PcgNewNode.update_value)
    prop_auto = BoolProperty(name="Auto Smooth", update=PcgNewNode.update_value)
    prop_angle = FloatProperty(name="Angle", default=0.523599, min=0.0, max=3.14159, subtype="ANGLE", unit="ROTATION", update=PcgNewNode.update_value)
...
class NewBeginForLoopNode(Node, PcgNewControlNode):
    bl_idname = "NewBeginForLoopNode"
    bl_label = "New Begin For Loop"

    mesh = PointerProperty(type=bpy.types.Object)

    def init(self, context):
        self.inputs.new("NewComponentSocket", "Component")
        self.outputs.new("NewInfoSocket", "End For Loop")
        self.outputs.new("NewComponentSocket", "Component")
        super().init(context)
    ...
    def post_execute(self):
        return self.mesh
class NewEndForLoopNode(Node, PcgNewControlNode):
    bl_idname = "NewEndForLoopNode"
    bl_label = "New End For Loop"

    mesh = PointerProperty(type=bpy.types.Object)

    prop_start = IntProperty(name="Start", default=1, update=PcgNewNode.update_value)
    prop_end = IntProperty(name="End", default=3, update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewInfoSocket", "Begin For Loop")
        self.inputs.new("NewComponentSocket", "Component")
        self.inputs.new("NewIntSocket", "Start").prop_prop = "prop_start"
        self.inputs.new("NewIntSocket", "End").prop_prop = "prop_end"
        self.outputs.new("NewComponentSocket", "Component")
        super().init(context)
    ...
    def post_execute(self):
        return self.mesh
class NewBeginForEachLoopNode(Node, PcgNewControlNode):
    bl_idname = "NewBeginForEachLoopNode"
    bl_label = "New Begin For-Each Loop"
    ...
    def init(self, context):
        self.inputs.new("NewComponentSocket", "Component")
        self.outputs.new("NewInfoSocket", "End For-Each Loop")
        self.outputs.new("NewComponentSocket", "Component")
        super().init(context)
    ...
    def post_execute(self):
        ...
        bpy.ops.object.mode_set(mode="EDIT")
        return self.mesh
class NewEndForEachLoopNode(Node, PcgNewControlNode):
    bl_idname = "NewEndForEachLoopNode"
    bl_label = "New End For-Each Loop"
    ...
    def init(self, context):
        self.inputs.new("NewInfoSocket", "Begin For-Each Loop")
        self.inputs.new("NewComponentSocket", "Component")
        self.outputs.new("NewComponentSocket", "Component")
        super().init(context)
    ...
    def post_execute(self):
        ...
        bpy.ops.object.mode_set(mode="EDIT")
        return self.mesh
class NewIfNode(Node, PcgNewControlNode):
    bl_idname = "NewIfNode"
    bl_label = "New If Node"

    prop_bool = BoolProperty(name="Condition", default=True, update=PcgNewNode.update_value)

    def init(self, context):
        self.inputs.new("NewUniversalSocket", "True")
        self.inputs.new("NewUniversalSocket", "False")
        self.inputs.new("NewBoolSocket", "Condition").prop_prop = "prop_bool"
        self.outputs.new("NewUniversalSocket", "")
        super().init(context)
...
class NewPivotNode(Node, PcgNewSettingNode):
    ...
    prop_pivot = EnumProperty(name="Pivot Point", items=[("BOUNDING_BOX_CENTER", "Bound Box Center", ""), ("CURSOR", "Cursor", ""), ("INDIVIDUAL_ORIGINS", "Individual Origins", ""), ("MEDIAN_POINT", "Median Point", ""), ("ACTIVE_ELEMENT", "Active Element", "")], default="MEDIAN_POINT", update=PcgNewNode.update_value)
...
'''
def init(self, context):
    self.puts.new("New.Socket", "M").prop_prop = "prop_"
    super().init(context)
...
testing = [NewFloat, NewInt, NewBool, NewAngle, NewFloatVector, NewAngleVector, NewRandomFloat, NewRandomInt, NewRandomBool, NewRandomAngle, NewMathOpNode, NewPrintNode, NewCubeNode, NewCylinderNode, NewCustomMeshNode, NewToComponentNode, NewToMeshNode, NewLocationNode, NewRotateNode, NewBevelModNode, NewBooleanModNode, NewSelectAllNode, NewSelectComponentsManuallyNode, NewDeleteNode, NewDissolveDegenerateNode, NewBevelNode, NewInsetNode, NewOriginNode, NewShadingNode, NewBeginForLoopNode, NewEndForLoopNode, NewBeginForEachLoopNode, NewEndForEachLoopNode, NewIfNode, NewCursorLocationNode, NewPivotNode, NewRefreshMeshNode, NewExportMeshFBX]
